...
import com.hipipal.texteditor.common.ColorPicker.OnColorChangedListener;

@SuppressLint({ "DrawAllocation", "ClickableViewAccessibility" }) public class ColorPickerView extends View {
